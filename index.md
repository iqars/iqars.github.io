...
| 02-10 | 9:30–11:00 | Alexandre Leblanc : <br> [Cloning of Encrypted Qubits](./materials/slides/QARS_10février_EncryptedQubitsCanBeCloned.pdf)| Victor Drouin-Touchette : <br> [Quantum Speedup for Abelian Hidden Subgroup Problem](./materials/slides/QARS_Feb_10.pdf)| Olivier Nahman-Lévesque : <br> Majorana Operators and [Quantum Theorem Proving](./materials/slides/Quantum_theorem_proving.pdf)| Simon Verret : <br> [Simon's Note on Majorana Operators](./materials/slides/Notes_Simon_Stabilizer.pdf)|
